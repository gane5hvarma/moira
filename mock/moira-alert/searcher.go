...
func (m *MockSearcher) SearchTriggers(arg0 []string, arg1 string, arg2 bool, arg3, arg4 int64) (moira.TriggerSearchResults, int64, error) {
	ret := m.ctrl.Call(m, "SearchTriggers", arg0, arg1, arg2, arg3, arg4)
	ret0, _ := ret[0].(moira.TriggerSearchResults)
	ret1, _ := ret[1].(int64)
	ret2, _ := ret[2].(error)
