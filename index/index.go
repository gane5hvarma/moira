...
type TriggerIndex interface {
	Search(filterTags []string, searchString string, onlyErrors bool, page int64, size int64) (triggerSearchResults moira.TriggerSearchResults, total int64, err error)
